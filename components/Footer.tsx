...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#181611] text-white py-16 px-6 sm:px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-white text-xl font-bold">Inmobiliaria Martorell</h2>
          </div>
          <p className="text-gray-400 text-sm leading-relaxed mb-6">
            Your trusted partner in finding the perfect luxury home in Spain's most coveted locations.
          </p>
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary hover:text-[#181611] flex items-center justify-center transition-all">
        ...
        {/* Links */}
        <div>
          <h3 className="text-lg font-bold mb-6 text-white">Properties</h3>
          <ul className="space-y-4 text-gray-400 text-sm">
            <li><Link to="/properties" className="hover:text-primary transition-colors">Villas for Sale</Link></li>
            <li><Link to="/properties" className="hover:text-primary transition-colors">Luxury Apartments</Link></li>
            <li><Link to="/properties" className="hover:text-primary transition-colors">New Developments</Link></li>
            <li><Link to="/properties" className="hover:text-primary transition-colors">Commercial</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>Av. del Mediterráneo, 12<br/>03730 Jávea, Alicante</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              ...
              <span>info@inmobiliariamartorell.com</span>
            </li>
          </ul>
        </div>
      </div>
      <div className="max-w-7xl mx-auto border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
        <p>© 2024 Inmobiliaria Martorell. All rights reserved.</p>
